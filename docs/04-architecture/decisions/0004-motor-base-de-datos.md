...
## Decisión
Se decide adoptar **PostgreSQL 17 (LTS)** como el motor de base de datos principal del proyecto Drivique, organizado bajo una arquitectura modular de sub-lenguajes SQL (`01_ddl`, `02_dml`, `03_dcl`, `04_tcl`, `05_rollbacks`) y control de cambios mediante Changelogs (`Liquibase`).
